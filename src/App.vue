  ...
  <div id="app">
    ...
    <b-navbar toggleable="md" type="dark" variant="info">
      ...
      <b-collapse is-nav id="nav_collapse">
        ...
        <b-navbar-nav>
          <b-nav-item href="#" v-on:click="openFormList()" v-show="isMenuValid()">
            <span class="oi oi-spreadsheet" title="spreadsheet" aria-hidden="true"></span>{{$t("message.form")}}
          </b-nav-item>
          <b-nav-item href="#" v-on:click="openAdmin()" v-show="isAdmin && isMenuValid()">
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown text="Lang" right v-show="isMenuValid()">
            <b-dropdown-item href="#">EN</b-dropdown-item>
            <b-dropdown-item href="#">JP</b-dropdown-item>
          </b-nav-item-dropdown>

          <b-nav-item-dropdown right v-show="isMenuValid()">
